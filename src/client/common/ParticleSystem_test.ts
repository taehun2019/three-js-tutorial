//https://ethank.tistory.com/entry/기존-자바스크립트-모듈-typescript-에서-사용하기
// var moduleA = require('./ParticleSystem');
// moduleA.hey();
...
//     _AddParticles(deltaTime: number) {
//         if (!this.gdfsghk) {
//             this.gdfsghk = 0.0;
//         }
...
//     _UpdateParticles(deltaTime: number) {
//         for (let p of this._particles) {
//             p.life -= deltaTime;
//         }
